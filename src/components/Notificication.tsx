...
export function Notification({type, message, title}: Props) {
      ...
      >
        <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <div className={`pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg ${type === 'success' && 'bg-green-50'} ${type === 'error' && 'bg-red-50'} ${type === 'info' && 'bg-blue-50'} shadow-lg ring-1 ring-black ring-opacity-5`}>
              <div className="p-4">
