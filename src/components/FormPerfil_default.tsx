                        ...
                        <div>
                            ...
                            <div className="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    className="block w-full min-w-0 py-2 px-3 flex-grow rounded-none rounded-r-md border-gray-300 focus:border-sky-500 focus:ring-sky-500 sm:text-sm"
                                    defaultValue={userPlaceholder.handle}
                                />
                            </div>
                        </div>
