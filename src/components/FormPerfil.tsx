...
export default function FormPerfil() {
    ...
    return (
        ...
        <form className="aba-config divide-y divide-gray-200 lg:col-span-9" action="" method="POST">
            {/* Profile section */}
            <div className="py-6 px-8 sm:p-6 lg:pb-8">
                <div>
                    <h2 className="text-lg font-medium leading-6 text-gray-900">Dados do Usuário</h2>
                    <p className="mt-1 text-sm text-gray-500">
                        Estas são suas informações de usuário
                    </p>
                </div>

                <div className="mt-6 pb-12 mb-8 flex flex-col lg:flex-row border-b-2 border-gray-200">
                        ...
                        <div>
                            ...
                            <div className="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    className="block w-full min-w-0 py-2 px-3 flex-grow rounded-none rounded-r-md border border-gray-300 focus:border-sky-500 focus:ring-sky-500 sm:text-sm"
                            ...
                            <div className="mt-1 lg:hidden">
                                <div className="flex items-center">
                                    <div
                                        ...
                                        aria-hidden="true"
                                    >
                                        <img className="h-full w-full rounded-full" src={userPlaceholder.imageUrl} alt="" />
                                    </div>
                ...
                <div className=''>
                    <h2 className="text-lg font-medium leading-6 text-gray-900">Dados da Empresa</h2>
                    <p className="mt-1 text-sm text-gray-500">
                        Estas são suas informações básicas da sua empresa
                    </p>
                </div>

                <div className="mt-8 mb-12 grid grid-cols-12 gap-6">
                    <div className="col-span-12 sm:col-span-6">
                        ...
                        <input
                            type="text"
                            value={user.empresa.nome_fantasia}
                            name="first-name"
                            id="first-name"
                    ...
                    <div className="col-span-12 sm:col-span-6">
                        ...
                        <input
                            value={user.empresa.razao_social}
                            type="text"
                            name="last-name"
                            id="last-name"
                    ...
                    <div className="col-span-12 sm:col-span-6">
                        ...
                        <input
                            value={user.empresa.contato_email}
                            type="text"
                            name="last-name"
                            id="last-name"
                            autoComplete="family-name"
